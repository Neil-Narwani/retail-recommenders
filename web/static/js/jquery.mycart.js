...
(function ($) {
  ...
  var loadMyCartEvent = function (targetSelector) {
    ...
    var classRecommendCart = options.classRecommendCart;
    ...
    */
    ...
    $(document).on('click', "." + classRecommendCart, function () {
      var products = ProductManager.getAllProducts();
      if (!products.length) {
        $("#" + idEmptyCartMessage).fadeTo('fast', 0.5).fadeTo('fast', 1.0);
        return;
      ...
      updateCart();
      var isCheckedOut = options.recommendCart(ProductManager.getAllProducts(), ProductManager.getTotalPrice(), ProductManager.getTotalQuantity());
      if (isCheckedOut !== false) {
        $cartBadge.text(ProductManager.getTotalQuantity());
        $("#" + idCartModal).modal("hide");
      }
