...
(function ($) {
  ...
  var OptionManager = (function () {
    ...
    var DEFAULT_OPTIONS = {
      ...
      getDiscountPrice: function (products, totalQuantity) {
        return null;
      }
    };
  ...
  var ProductManager = (function () {
    ...
    */
    ...
    var addProduct = function (id, name, quantity) {
      var products = getAllProducts();
      products.push({
        id: id,
        name: name,
    ...
    */
    ...
    var setProduct = function (id, name, quantity) {
  ...
  var loadMyCartEvent = function (targetSelector) {
    ...
    if (options.cartItems && options.cartItems.constructor === Array) {
      ...
      $.each(options.cartItems, function () {
        ProductManager.setProduct(this.id, this.name, this.quantity);
      });
    }
    ...
    */
    ...
    $(document).on("input", "." + classProductQuantity, function () {
      ...
      $(this).parent("td").next("." + classProductTotal).text(options.currencySymbol + MathHelper.getRoundedNumber(quantity));
    ...
    $(document).on('click', targetSelector, function () {
      ...
      ProductManager.setProduct(id, name,  quantity);
      $cartBadge.text(ProductManager.getTotalQuantity());
